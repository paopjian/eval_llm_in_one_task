...
# -*- coding: utf-8 -*-
"""
GLM (GLM-5.3-flash) core —— 提炼自 glm/eval_similar.py
...
MODEL_NAME = 'glm'
MODEL_DESC = 'GLM-5.3-flash 方法：spawn + 动态tile队列负载均衡 + fp32精确(关TF32)'
ORIGIN = 'glm/eval_similar.py (gpu_worker / run_pass；bins 2M -> 统一 200K，回传改队列)'
